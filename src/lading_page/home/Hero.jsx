...
<img src={stock1} alt="Hero Image" className='bg-blue-900 mt-15' style={{width:'50vw'}} />
    <h1 className='investheading pl-4 pr-4' >Invest in Everything</h1>
    <p className='pl-4 pr-4'>Online platform to invest in stocks, derivatives, mutual funds, ETFs, bonds, and more.</p>
